...
---@type vim
    ...
    keys = {
      -- This sets Ctrl+n to toggle the file explorer
      { "<leader>e", "<cmd>Neotree toggle<cr>", desc = "Neo-tree Toggle" },
    },
    opts = {
      filesystem = {
        filtered_items = {
          visible = true, -- Shows hidden files (like .gitignore)
          hide_dotfiles = false,
        },
        follow_current_file = {
          enabled = true, -- Focuses the file you are currently editing in the tree
        },
      },
      window = {
        width = 30,
